package com.streamlinity.ct.springRestChallenge;
...
//    Handy code to dump out beans loaded if there are issues.
//    @Autowired
//    ApplicationContext appContext;
//
//    @EventListener(ApplicationReadyEvent.class)
//    public void logLoadedBeanDefinitionNames() {
//        logger.info(String.format("Number of beans instantiated: %d", appContext.getBeanDefinitionCount()));
//        for (int i=0; i<appContext.getBeanDefinitionCount(); i++) {
//            logger.info(String.format("Beans[%d]: %s", i, appContext.getBeanDefinitionNames()[i]));
//        }
//
//    }
}
